...
@Component({
  selector: 'app-form-input-string-admin-comp',
  templateUrl: './form-input-string-admin-comp.component.html',
  styleUrls: ['./form-input-string-admin-comp.component.css']
})
export class FormInputStringAdminCompComponent implements OnInit {
